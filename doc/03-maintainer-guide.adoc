...
If you are using gmail, you can request a unique token for clj-yaml CI by including `+clj-yaml` in your email address, ex. `bob@gmail.com` becomes `bob+clj-yamle@gmail.com`.
